 ...
 * `stockNumber` limits quantity *increases* only; the CTA can still render
 * when stock is zero. Disables the CTA while the cart store is mutating.
 */
 ...
 * @param stockNumber - Caps quantity *increases* (does not disable add when zero).
